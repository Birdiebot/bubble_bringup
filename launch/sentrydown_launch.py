...
FilePath: /bubble_bringup/launch/sentrydown_launch.py
LastEditors: Ligcox
LastEditTime: 2022-05-30 06:17:49
...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, 'config', 'sentrydown_params.yaml'),
        description='Full path to the ROS2 parameters file to use for all launched nodes')

    declare_serial_port_file_cmd = DeclareLaunchArgument(
        'serial_port',
        default_value='/dev/ttyTHS2',
        description='Sentry robot Onboard serial port name')
